...
const fr = {
  ...
  SEQUELIZE_UPDATE: `Erreur lors de la mise à jour de la base de données`,
  UPLOAD_FAILED: `Echec de la téléchargement de la fichier`,
  SEQUELIZE: `Erreur de la base de données`,
  LOGIN: `Echec de l'authentification`,
  FORBIDDEN: `Accès refusé`,
  DUPLICATE: `Erreur de duplicité`,

  ProjReference: 'Référence',
  ProjReport: `Rapport`,
  ProjResource: `Ressource`,
  ProjUser: 'Utilisateur',
  ProjVehicle: 'Véhicule',
