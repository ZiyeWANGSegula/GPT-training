...
export default function TestStatuFieldsSection({ title }) {
    ...
    const estimatedDate = watch(`${title}estimatedDate`);
    const validatedDate = watch(`${title}validatedDate`);
        ...
        <Box sx={{ width: '100%', height: '100%', bgcolor: 'background.paper', display: 'flex', flexDirection: 'column' }}>
            ...
            <TabPanel value={tabValue} index={0}>
                <Box
                    ...
                    <TextField label="Estimated Date" type="date" InputLabelProps={{ shrink: true }} {...register(`${title}estimatedDate`)}/>
                    <TextField label="Real Date" type="date" InputLabelProps={{ shrink: true }} {...register(`${title}validatedDate`)}/>
