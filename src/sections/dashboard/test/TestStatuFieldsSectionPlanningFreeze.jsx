...
export default function TestStatuFieldsSectionPlanningFreeze({ title }) {
        ...
        <Box sx={{ width: '100%', height: '100%', bgcolor: 'background.paper', display: 'flex', flexDirection: 'column' }}>
            ...
            <TabPanel value={tabValue} index={0}>
                <Box
                    ...
                    <TextField label="Start of test" type="date" InputLabelProps={{ shrink: true }} />
                    <TextField label="End of test" type="date" InputLabelProps={{ shrink: true }} />
                    ...
                    <TextField label="Validated by customer" fullWidth />
                    {showExtraFields && (
                        <React.Fragment>
