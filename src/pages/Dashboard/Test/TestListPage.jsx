...
const TABLE_HEAD = [
  ...
  { id: 'referentId', label: 'Referent', align: 'left' },
  { id: 'referentCustomerId', label: 'Customer', align: 'left' },
...
export default function TestListPage() {
  ...
  const isFiltered = filterName !== '' || filterFirstDate !== "" || filterLastDate !== "" || filterStatus !== 'all';
...
function applyFilter({ inputData, comparator, filterName, filterFirstDate,
  filterLastDate}) {
  ...
  if (filterName) {
    inputData = inputData.filter(
      (Test) => Test.lib.toLowerCase().indexOf(filterName.toLowerCase()) !== -1
    );
  }
